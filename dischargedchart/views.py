...
from discharge.models  import Dischargeddata
...
# Chart data is passed to the `dataSource` parameter, like a dictionary in the form of key-value pairs.
  ...
  # The `chartConfig` dict contains key-value pairs of data for chart attribute
    ...
    chartConfig["caption"] = "Chart representation of Gender in Discharged "
  ...
  # Insert the data into the `dataSource['data']` list.
    ...
    hope = Dischargeddata.objects.filter(Sex='MALE').count()        
    data = {}
    data['label'] = 'Male'
    data['value'] = hope
    dataSource['data'].append(data)
        
    hope3 = Dischargeddata.objects.filter(Sex='FEMALE').count()  
    ...
    numberOfCases = Dischargeddata.objects.all().count()
  ...
  # The chart data is passed to the `dataSource` parameter.
    ...
    return render(request, 'dischargedchart/dashboard.html', {
...
def diseaseChart(request):
  ...
  # Chart data is passed to the `dataSource` parameter, like a dictionary in the form of key-value pairs.
    ...
    hope = Dischargeddata.objects.filter(Sex='MALE')
    hope2 = hope.filter(Disease=diseaseNam).count()        
    data = {}
    data['label'] = 'Male'
    data['value'] = hope2
    dataSource['data'].append(data)
    ...
    femaleFilter = Dischargeddata.objects.filter(Sex='FEMALE')
    ...
    numberOfCases= Dischargeddata.objects.filter(Disease=diseaseNam).count
    ...
    return render(request, 'dischargedchart/disease Statistics.html', {
