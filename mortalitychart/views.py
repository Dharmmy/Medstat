...
from mortality.models  import MortalityData
...
# Chart data is passed to the `dataSource` parameter, like a dictionary in the form of key-value pairs.
  ...
  # Insert the data into the `dataSource['data']` list.
    ...
    hope = MortalityData.objects.filter(Sex='male').count()        
    data = {}
    data['label'] = 'male'
    data['value'] = hope
    dataSource['data'].append(data)
        
    hope = MortalityData.objects.filter(Sex='female').count()  
    ...
    numberOfCases = MortalityData.objects.all().count()
  ...
  # The chart data is passed to the `dataSource` parameter.
    ...
    return render(request, 'mortalitychart/dashboard.html', {
...
# Chart data is passed to the `dataSource` parameter, like a dictionary in the form of key-value pairs.
  ...
  hope = MortalityData.objects.filter(Disease=diseaseNam)
  ...
  femaleFilter = MortalityData.objects.filter(Sex='female')
  ...
  numberOfCases= MortalityData.objects.filter(Disease=diseaseNam).count
  ...
  return render(request, 'mortalitychart/disease Statistics.html', {
